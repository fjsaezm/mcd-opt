...
\end{problem}
    ...
    Además, vamos a resolver el problema de minimización, que tiene el signo opuesto
    ...
    Podemos ver primero que nuestra matriz \(A\) escrita anteriormente \textbf{no tiene} una submatriz identidad, por lo que añadimos \textbf{variables artificiales} para generarla, y utilizaremos por tanto el \textbf{método de las dos fases}. El problema queda entonces definido del siguiente modo:


    Primero, definimos la tabla inicial usando las variables artificiales.
...
En primer lugar, hacemos ceros en las variables básicas de la primera fila. Para ello, sumamos la fila correspondiente a $x_4$ la priemra fila:
